...
[📖 Documentation](#framework-architecture) • [🚀 Quick Start](#quick-start-your-first-session) • [📚 Resources](#additional-resources) • [🔗 View All Files](index.md)
...
| Feature | Description |
|---------|-------------|
| 🧠 **System Thinking** | Every action considers end-to-end impact |
| ✅ **Evidence-Based** | Trust is earned through verification, not assumptions |
| 🤖 **True Autonomy** | Agents make decisions within clear guardrails |
...
**Installation:**
- 🌐 **Global (Recommended):** Install as a global rule in your AI environment
- 📁 **Project-Specific:** Place in `.cursor/rules/` or project root `AGENT.md`

> ⚠️ **Important:** Treat the Manifest as infrastructure-as-code. When updating, replace the entire file to prevent configuration drift.
...
### 3. 🎛️ Behavior Modifiers

Optional, stackable behavior adjustments for specific communication styles or operational modes.
...
Copy the contents of [`manifest.md`](manifest.md) into your Cursor rules (global or project-specific).

### Step 2: Choose Your Workflow

Select the appropriate workflow template:
- **🔨 Building something new?** → Use [`workflows/build.md`](workflows/build.md)
- **🔍 Debugging a persistent issue?** → Use [`workflows/diagnose.md`](workflows/diagnose.md)
- **🔄 Migrating data?** → Use [`workflows/migrate.md`](workflows/migrate.md)
- **📈 Wrapping up a session?** → Use [`workflows/evolve.md`](workflows/evolve.md)
...
After completion, use [`workflows/evolve.md`](workflows/evolve.md) to capture learnings and improve the framework.
...
5. Documentation      → Update docs, clean workspace, report findings
```
...
This framework is designed to evolve. Use [`workflows/evolve.md`](workflows/evolve.md) regularly to:
...
**Framework Author:** [Moeid Saleem Khan](https://github.com/moeidsaleem)
...
[⭐ Star this repo](https://github.com/moeidsaleem/agentic-engineering-framework) • [📖 View Documentation](index.md) • [🐛 Report Issues](https://github.com/moeidsaleem/agentic-engineering-framework/issues)
